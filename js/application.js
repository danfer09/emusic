var Application = {
   initApplication: function() {
      ...
      $(document).on(
         ...
         {
            if (properties.absUrl === $.mobile.path.makeUrlAbsolute('reproductor.html'))
            {
   ...
   createFilesList: function(idElement, files)
   {
      ...
      {
         $('#' + idElement).append('<p>No se encontraron archivos, refresque por favor (arriba a la derecha)</p>');
         return;
      }
